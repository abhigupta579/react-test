      ...
      <div className='container'>
        ...
        <div className='row center'>
            <div className='col-md-6 colCenter'>
                <h3 className='centerHead'>THIS IS SOME CONTENT ALIGNED IN THS CENTER<br/> VERTICALLY AND HORIZONTALLY</h3>
            </div>
        ...
        <div className='row footer'>
            <div className='col-md-12 colFooter'>
                <h3>THIS IS THE FOOTER CONTENT WHICH IS ALIGNED<br/><span className='left'>LEFT</span></h3>
            </div>
        </div>
      </div>
    </div>
